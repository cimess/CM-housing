...
Login as House Owner
 ...
 <span className="text-gray-600 mb-5">Dont have have an account? </span><Link to='/Register' className="underline ml-2">Register now</Link>
  ...
  <form className=" w-[80%] mx-auto text-left">
   ...
   <input type="email" className="border rounded border-gray-500 w-full  focus:outline-none h-10"/>
   <label className="block text-sm font-bold my-3">Password</label>
  <input 
  type="password" 
  className="border rounded border-gray-500 w-full focus:outline-none h-10"
/>

 <div className="flex space-x-3 items-center mt-7">
  <input 
  type="checkbox" 
  className="border rounded border-gray-500 focus:outline-none h-5 w-5 accent-black"
/>
...
<Link className="text-center block mt-5">Forgot Password?</Link>
  </form>
