    ...
    <div className="flex ">
      <div className="w-[30%] lg:w-[50%] ">
        <main className="shadow rounded-lg h-[500px] py-4 ">
          ...
          <div
            className="flex py-3 gap-x-3 px-2 border-b-1 cursor-pointer mt-10 hover-bg items-center"
          ...
          <div
            className="flex py-3 gap-x-3 px-2 border-b-1 cursor-pointer hover-bg"
          ...
          <div
            className="flex py-3 gap-x-3 px-2 border-b-1 cursor-pointer hover-bg items-center"
            ...
            >
              ...
              <div className="px-1 py-2">
                ...
                <div className="flex gap-x-4">
                  <p>
                    {" "}
                    <FontAwesomeIcon icon={faBed} /> {advert.bedrooms}{" "}
                  </p>{" "}
                  <p>
                    <FontAwesomeIcon icon={faBathtub} /> {advert.bathrooms}
                  </p>{" "}
                  <p>
                    <FontAwesomeIcon icon={faDog} /> {advert.pet}
                  </p>
                </div>
